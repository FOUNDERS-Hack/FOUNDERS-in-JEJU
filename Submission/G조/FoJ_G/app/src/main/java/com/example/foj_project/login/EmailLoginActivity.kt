package com.example.foj_project.login
...
import com.example.foj_project.*
import kotlinx.android.synthetic.main.activity_email_login.*
import com.example.foj_project.R
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        loginViewModel.loginResult.observe(this@EmailLoginActivity, Observer {
            ...
            if (loginResult.success != null) {
                ...
                val intent = Intent(this@EmailLoginActivity, Shop2Activity::class.java)
